...
(function () {
  var STR = {
    en: {
      ...
      hero_find_event: "Find an event", hero_book_session: "Book a session", hero_cue: "Release, Relax, Unwind",
      ...
      contact_heading: "Have a question?", contact_text: "Ready to reconnect with nature and yourself? Feel free to reach out — we'd love to help you find the experience that's right for you.", read_more: "Read more", read_less: "Show less",
      about_short: "I'm Tanya — I work with body-oriented, trauma-informed therapy for stress, burnout, trauma and nervous-system regulation.",
      about_intro: "<p>I’m Tanya, founder of Re-balance.</p><p>I hold a Master of Social Science (Cand.Soc.) and have spent more than a decade working with stress, movement, and nervous system regulation.</p><p>My background combines psychotherapy training, bodywork, yoga, Functional Relaxation, qigong, mindfulness, and neuroscience-informed approaches to stress and trauma.</p>",
      ...
      thanks_private: "Thank you for requesting a private session — I'm so glad you're here! You'll hear back from me within 24 hours.",
      thanks_call: "Thanks for requesting a 20-minute call — I'm so glad you're here! You'll hear back from me within 24 hours.",
      thanks_evening: "Thank you for signing up for Rest & Digest Evening{when}! Can't wait to see you there!",
      thanks_morning: "Thank you for signing up for Rest & Digest Morning{when}! Can't wait to see you there!",
      when_prefix: " on {date} at {time}",
      sign_warmly: "Warmly,<br>Tanya",
      ...
      page_title_gallery: "Gallery — Re-balance", page_title_about: "About — Re-balance",
      booked: "✓ Booked",
    ...
    da: {
      ...
      contact_heading: "Har du et spørgsmål?", contact_text: "Klar til at genfinde forbindelsen til naturen og dig selv? Kontakt os – vi hjælper dig gerne med at finde den oplevelse, der passer til dig.", read_more: "Læs mere", read_less: "Vis mindre",
      about_short: "Jeg er Tanya — jeg arbejder med kropsorienteret, traumeinformeret terapi til stress, udbrændthed, traumer og regulering af nervesystemet.",
      about_intro: "<p>Jeg er Tanya, grundlægger af Re-balance.</p><p>Jeg har en kandidat i samfundsvidenskab (Cand.Soc.) og har i mere end ti år arbejdet med stress, bevægelse og regulering af nervesystemet.</p><p>Min baggrund kombinerer psykoterapeutisk uddannelse, kropsterapi, yoga, Funktionel Afspænding, qigong, mindfulness og neurovidenskabeligt informerede tilgange til stress og traumer.</p>",
      ...
      thanks_private: "Tak fordi du har anmodet om en privat session — jeg er så glad for, at du er her! Du hører fra mig inden for 24 timer.",
      thanks_call: "Tak fordi du har anmodet om en 20-minutters samtale — jeg er så glad for, at du er her! Du hører fra mig inden for 24 timer.",
      thanks_evening: "Tak fordi du har tilmeldt dig Rest & Digest – aften{when}! Jeg glæder mig til at se dig!",
      thanks_morning: "Tak fordi du har tilmeldt dig Rest & Digest – morgen{when}! Jeg glæder mig til at se dig!",
      when_prefix: " den {date} kl. {time}",
      sign_warmly: "Kærlig hilsen,<br>Tanya",
      ...
      page_title_gallery: "Galleri — Re-balance", page_title_about: "Om mig — Re-balance",
      booked: "✓ Booket",
