...
(function () {
  var STR = {
    en: {
      ...
      hero_intro: "Guided nature hikes, retreats and 1:1 therapy with Tanya Ekelin — slow down, breathe, and find your footing in the wild.",
      ...
      gallery_intro: "Moments from our hikes and retreats. Tap any photo to enlarge.",
    ...
    da: {
      ...
      hero_intro: "Guidede naturvandringer, retreats og 1:1-terapi med Tanya Ekelin — sæt tempoet ned, træk vejret, og find fodfæste i naturen.",
      ...
      gallery_intro: "Øjeblikke fra vores vandringer og retreats. Tryk på et billede for at forstørre.",
    ...
    uk: {
      ...
      hero_intro: "Сповільніться, дихайте та віднайдіть опору на природі — походи з гідом, ретрити й індивідуальна терапія з Танею Екелін.",
      ...
      gallery_intro: "Миті з наших походів і ретритів. Торкніться фото, щоб збільшити.",
