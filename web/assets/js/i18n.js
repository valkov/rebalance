...
(function () {
  var STR = {
    en: {
      ...
      book_pay: "Book & pay", reserve_spot: "Reserve a spot", enquire: "Enquire", view_details: "View details →", pkg_one: "Buy 1 session", pkg_other: "Buy {n} sessions",
      ...
      about_p1: "I work with a body-oriented, trauma-informed approach that gently supports your nervous system in finding greater balance and regulation. Together, we create the conditions for your body to rediscover a sense of safety—because lasting change becomes possible when we feel safe enough to soften, connect, and heal.",
      about_p2: "As your nervous system becomes more regulated, you can experience greater resilience, improved wellbeing, and a renewed connection to your body's natural capacity to heal, recover, and thrive.",
      see_events: "See events", langs_display: "Danish, English",
      parallax_quote: "Slow down, breathe, and rebalance.",
      reviews_eyebrow: "Feedback from clients", reviews_heading: "In their words", reviews_line: "recommend · based on 32 reviews on Facebook",
    ...
    da: {
      ...
      book_pay: "Book & betal", reserve_spot: "Reservér plads", enquire: "Forespørg", view_details: "Se detaljer →", pkg_one: "Køb 1 session", pkg_other: "Køb {n} sessioner",
      ...
      about_p1: "Jeg arbejder med en kropsorienteret, traumeinformeret tilgang, der nænsomt støtter dit nervesystem i at finde større balance og regulering. Sammen skaber vi betingelserne for, at din krop kan genopdage en følelse af tryghed—for varig forandring bliver mulig, når vi føler os trygge nok til at åbne op, skabe forbindelse og hele.",
      about_p2: "Efterhånden som dit nervesystem bliver mere reguleret, kan du opleve større modstandskraft, øget trivsel og en fornyet forbindelse til kroppens naturlige evne til at hele, restituere og trives.",
      see_events: "Se begivenheder", langs_display: "Dansk, engelsk",
      parallax_quote: "Sæt tempoet ned, træk vejret, og find balancen.",
      reviews_eyebrow: "Feedback fra klienter", reviews_heading: "Med deres egne ord", reviews_line: "anbefaler · baseret på 32 anmeldelser på Facebook",
