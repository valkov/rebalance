...
(function () {
  var STR = {
    en: {
      ...
      page_title_events: "Events — Trail to Thriving",
      page_title_sessions: "Sessions — Trail to Thriving",
      page_title_groups: "Classes — Trail to Thriving",
      ...
      review_q2: "This was my second hiking trip with Trail to Thriving. Saying that I enjoyed it would be a huge understatement. Both trips were truly special, unique, and unforgettable. My mind completely reset, and my body showed me what I can. Hiking in nature is wonderful on its own, but sharing the experience with the organizers and a welcoming group where you can talk, laugh, enjoy peaceful moments in silence, and discover new practices — made it exactly what I needed.",
      ...
      review_author: "Trail to Thriving member",
    ...
    da: {
      ...
      page_title_events: "Begivenheder — Trail to Thriving",
      page_title_sessions: "Sessioner — Trail to Thriving",
      page_title_groups: "Gruppesessioner — Trail to Thriving",
      ...
      review_author: "Trail to Thriving-deltager",
    ...
    ua: {
      ...
      page_title_events: "Події — Trail to Thriving",
      page_title_sessions: "Сесії — Trail to Thriving",
      page_title_groups: "Групові сесії — Trail to Thriving",
      ...
      review_q2: "Уже другий раз була я разом із Trail to Thriving в поході. Сказати, що сподобалося — це не сказати нічого. Все було чудово, дуже незвично, але пам'ятно в обох походах. Мій мозок перезавантажився на 100 відсотків, мої м'язи показали, що я МОЖУ. Прогулянки на природі самі по собі чудові, але разом із дівчатами-організаторами, з групою, де можна і поговорити, і посміятися, і просто побути в тиші наодинці з природою, познайомитися з новими практиками — це те, що мені було дуже потрібно.",
      ...
      review_author: "Учасниця Trail to Thriving",
