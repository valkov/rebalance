...
window.SITE_CONFIG = {
  ...
  sanity: { projectId: "a0vcqlnf", dataset: "production", apiVersion: "2024-01-01" },
  ...
  brand: {
    ...
    email: "hello@trailtothriving.com", // TODO: your real contact email
    instagram: "https://www.instagram.com/green.body.lab/",
    facebook: "https://www.facebook.com/trailtothriving/",
    // Telegram channel/group — use a t.me link (telegram.com is NOT Telegram's
    // address). This is a placeholder guess; replace with the real link.
    // Leave "" to hide the Telegram link entirely.
    telegram: "https://t.me/trailtothriving",
  },
  ...
  events: [
    {
      ...
      hue: 205,
      image: "assets/images/demo-2.jpg", // swap for your own fjord photo
      stripeUrl: "", // e.g. "https://buy.stripe.com/xxxxxxxx"
    },
    {
